        ...
        Align(
          ...
          child: Padding(
            ...
            child: TextButton(
              child: Text(
                'Skip',
                style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(colorPrimary)),
              ).tr(),
              onPressed: () {
                pushAndRemoveUntil(
                    context,
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Text(
                ...
                style: TextStyle(color: Color(colorPrimary), fontSize: 24.0, fontWeight: FontWeight.bold),
              ).tr(),
            ),
            Padding(
            ...
            Padding(
              ...
              child: ConstrainedBox(
                ...
                child: TextButton(
                  child: Text(
                    "Sign Up",
                    style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color(colorPrimary)),
                  ).tr(),
                  onPressed: () {

                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(fontSize: 20, fontFamily: "Poppinsm", color: Color(colorPrimary)),
                      ),
                    ],
                  ),
                ),
                ...
                GestureDetector(
                  onTap: () {
                    BottomPicker.dateTime(
                      ...
                      title: '',
                      buttonContent: Text('Confirm', style: const TextStyle(color: Colors.white)),
                      buttonSingleColor: Color(colorPrimary),
                      buttonStyle: BoxDecoration(
                        color: Color(colorPrimary), // Remplacez COLOR_PRIMARY par votre couleur préférée.
                        borderRadius: BorderRadius.circular(4.0), // Exemple de rayon de bordure, ajustez selon vos besoins.
                      ),
                    ).show(context);
                  },
                  child: Text(
                    scheduleTime == null ? "Select".tr() : DateFormat("EEE dd MMMM , HH:mm aa").format(scheduleTime!.toDate()),
                    style: TextStyle(fontFamily: "Poppinsm", color: Color(colorPrimary)),
                  ),
                )
              ],
            )),
    ...
    return showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            actions: <Widget>[
              new ElevatedButton(
                style: ElevatedButton.styleFrom(backgroundColor: Color(colorPrimary), textStyle: TextStyle(fontWeight: FontWeight.normal)),

                            ...
                            GestureDetector(
                              ...
                              child: new Align(
                                  ...
                                  child: Container(
                                    ...
                                    decoration:
                                        BoxDecoration(borderRadius: BorderRadius.circular(100), border: Border.all(width: 1, color: isDarkMode(context) ? Color(colorPrimary) : Colors.black54)),
                                    child: Icon(
                                      Icons.keyboard_arrow_right,
                                      color: isDarkMode(context) ? Color(colorPrimary) : Colors.black54,
                                    ),
                                  )),
                            ),
                          ],
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return Padding(
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Card(
                                          elevation: 5,
                                          color: isSelected ? Color(colorPrimary) : Colors.white,
                                          shape: RoundedRectangleBorder(

                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(currentLocation.toString(), maxLines: 2, overflow: TextOverflow.ellipsis, style: TextStyle(color: Color(colorPrimary), fontFamily: "Poppinsr")).tr(),
                            ),
                            InkWell(
                              onTap: () {
                              ...
                              child: Container(
                                ...
                                child: Text("Change", style: TextStyle(fontSize: 14, color: Color(colorPrimary), fontFamily: "Poppinsr")).tr(),
                              ),
                            ),
                          ],
                        ),
            ...
            children: [
              CachedNetworkImage(
                ...
                imageBuilder: (context, imageProvider) => Container(
                  ...
                  decoration: BoxDecoration(border: Border.all(width: 4, color: Color(colorPrimary)), borderRadius: BorderRadius.circular(25)),
                  child: Container(
                    decoration: BoxDecoration(
                        border: Border.all(
                          width: 4,

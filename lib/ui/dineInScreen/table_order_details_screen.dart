...
class _TableOrderDetailsScreenState extends State<TableOrderDetailsScreen> {
  ...
  void initState() {
    ...
    if (widget.bookTableModel.status == ORDER_STATUS_PLACED) {
      ...
      polyLinesFuture = polylinePoints.getRouteBetweenCoordinates(googleApiKey, PointLatLng(widget.bookTableModel.vendor.latitude, widget.bookTableModel.vendor.longitude),
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              SizedBox(height: 22, child: Icon(Icons.check_circle, color: Color(colorPrimary))),
                              SizedBox(
                                height: 36,
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      "|",
                                      style: TextStyle(fontWeight: FontWeight.bold, color: Color(colorPrimary), fontSize: 8),
                                    ),
                                    Text(
                                      "|",
                                      style: TextStyle(fontWeight: FontWeight.bold, color: Color(colorPrimary), fontSize: 8),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "$bookStatus".tr(),
                                    style: TextStyle(
                                      color: (bookStatus == 'Confirmed') ? Colors.green : Color(colorPrimary),
                                      fontWeight: FontWeight.w600,
                                      fontSize: 16,
                                    ),
                                  ),
                  ...
                  child: Column(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          "Booking Details".tr(),
                          style: TextStyle(color: Color(colorPrimary), fontSize: 16, fontWeight: FontWeight.w600),
                        ),
                      ),
                      Card(
                        color: isDarkMode(context) ? Color(DARK_CARD_BG_COLOR) : Color(0xffFFFFFF),
                                ...
                                child: ClipOval(
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Icon(Icons.subdirectory_arrow_left, color: Color(colorPrimary), size: 22),
                                    ),
                                  ),
                                ),
                              ),
                              ...
                              child: Padding(
                                ...
                                child: ClipOval(
                                  child: Container(
                                    ...
                                    child: Padding(
                                      padding: const EdgeInsets.all(10.0),
                                      child: Icon(Icons.phone, color: Color(colorPrimary), size: 22),
                                    ),
                                  ),
                                ),
                              ),

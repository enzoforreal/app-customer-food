              ...
              child: Column(
                ...
                children: [
                  ...
                  product.disPrice == "" || product.disPrice == "0"
                      ? Text(
                          amountShow(amount: product.price),
                          style: TextStyle(fontSize: 16, fontFamily: "Poppinsm", letterSpacing: 0.5, color: Color(colorPrimary)),
                        )
                      : Row(
                          children: [
                            Text(
          ...
          children: [
            CachedNetworkImage(
              ...
              imageBuilder: (context, imageProvider) => Container(
                ...
                decoration: BoxDecoration(border: Border.all(width: 6, color: Color(colorPrimary)), borderRadius: BorderRadius.circular(30)),
                child: Container(
                  // height: 80,width: 80,
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(20),

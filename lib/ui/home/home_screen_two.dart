...
class _HomeScreenTwoState extends State<HomeScreenTwo> {
              ...
              : (MyAppState.selectedPosotion.latitude == 0 && MyAppState.selectedPosotion.longitude == 0)
                  ? Center(
                      child: showEmptyState("We don't have your location.".tr(), context, description: "Set your location to started searching for restaurants in your area".tr(), action: () async {
                        LocationResult result = await Navigator.of(context).push(MaterialPageRoute(builder: (context) => PlacePicker(googleApiKey)));
                                  ...
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(30.0), borderSide: BorderSide(color: Color(colorPrimary), width: 2.0)),
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Text('View All'.tr(), style: TextStyle(color: Color(colorPrimary), fontFamily: "Poppinsm")),
                                        ),
                                      ],
                                    ),
                                    GradientText(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: Text('See All'.tr(), style: TextStyle(color: Color(colorPrimary), fontFamily: "Poppinsm")),
                                      ),
                                    ],
                                  ),
                                ),
  ...
  Widget buildBestDealPage(BannerModel categoriesModel) {
    return InkWell(
      onTap: () async {
        if (categoriesModel.redirectType == "store") {
          VendorModel? vendorModel = await FireStoreUtils.getVendor(categoriesModel.redirectId.toString());
          push(
            context,
            NewVendorProductsScreen(vendorModel: vendorModel!),
          );
        } else if (categoriesModel.redirectType == "product") {
          ProductModel? productModel = await fireStoreUtils.getProductByProductID(categoriesModel.redirectId.toString());
        ...
        } else if (categoriesModel.redirectType == "external_link") {
          final uri = Uri.parse(categoriesModel.redirectId.toString());
          if (await canLaunchUrl(uri)) {
            await launchUrl(uri);
          } else {
            throw "Could not launch".tr() + " ${categoriesModel.redirectId.toString()}";
          }
        }
      },
      child: Padding(
        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              child: Text(
                "COPY CODE".tr(),
                style: TextStyle(color: Color(colorPrimary), fontWeight: FontWeight.w500, letterSpacing: 0.1),
              ),
            ),
          ),
          Container(

        ...
        child: ListView(
          children: <Widget>[
            Padding(
              ...
              child: Text(
                'Sing In',
                style: TextStyle(color: Color(colorPrimary), fontSize: 25.0, fontWeight: FontWeight.bold),
              ).tr(),
            ),
                ...
                child: Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(color: Color(colorPrimary), fontWeight: FontWeight.bold, fontSize: 16, letterSpacing: 1),
                      ),
                    ])),
              ),
            )

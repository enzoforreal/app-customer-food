              ...
              child: Positioned(
                  ...
                  child: Container(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(6)), backgroundColor: Color(colorPrimary)),
                        child: Text(
                          "GET STARTED".tr(),
          ...
          Center(
            ...
            child: Align(
              ...
              child: SmoothPageIndicator(
                ...
                effect: ScrollingDotsEffect(spacing: 20, activeDotColor: Color(colorPrimary), dotColor: Color(0XFFFBDBD1), dotWidth: 7, dotHeight: 7, fixedCenter: false),
              ),
            ),
          )),
          Visibility(
          ...
          Visibility(
              ...
              child: Positioned(
                  ...
                  child: InkWell(
                      ...
                      child: Text(
                        "SKIP".tr(),
                        style: TextStyle(fontSize: 18, color: Color(colorPrimary), fontFamily: 'Poppinsm'),
                      )))),
          Visibility(
              visible: _currentIndex + 1 != _imageList.length,
              child: Positioned(

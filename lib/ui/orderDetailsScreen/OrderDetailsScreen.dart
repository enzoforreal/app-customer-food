              ...
              widget.orderModel.takeAway == false
                  ? Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Address'.tr(),
                          style: TextStyle(fontSize: 16, letterSpacing: 0.5, color: isDarkMode(context) ? Colors.grey.shade200 : Color(colorPrimary), fontFamily: "Poppinsm"),
                        ),
              ...
              (widget.orderModel.notes != null && widget.orderModel.notes!.isNotEmpty)
                  ? ListTile(
                      ...
                      trailing: InkWell(
                        ...
                        child: Text(
                          "View".tr(),
                          style: TextStyle(fontSize: 18, color: Color(colorPrimary), letterSpacing: 0.5, fontFamily: 'Poppinsm'),
                        ),
                      ),
                    )
                  : Container(),
              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: InkWell(
                    child: Container(
                        padding: const EdgeInsets.only(top: 8, bottom: 8),
                        decoration: BoxDecoration(color: Color(colorPrimary), borderRadius: BorderRadius.circular(5), border: Border.all(width: 0.8, color: Color(colorPrimary))),
                        child: Center(
                          child: Text(
...
//   ]);
  ...
  getPriceTotalText(CartProduct s) {
    ...
    return Text(
      amountShow(amount: total.toString()),
      style: TextStyle(fontSize: 20, color: Color(colorPrimary), fontFamily: "Poppinsm"),
    );
  }

...
class _ProductDetailsScreenState extends State<ProductDetailsScreen> {
                          ...
                          children: [
                            ...
                            widget.productModel.disPrice == "" || widget.productModel.disPrice == "0"
                                ? Text(
                                    ...
                                    style: TextStyle(fontFamily: "Poppinsm", letterSpacing: 0.5, color: Color(colorPrimary)),
                                  )
                                : Row(
                                    children: [
                                      Text(
                                  ...
                                  : isOpen == false
                                      ...
                                      : Row(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              productQnt.toString(),
                                              style: TextStyle(fontSize: 16, fontFamily: "Poppinsm", color: Color(colorPrimary)),
                                            ),
                                            const SizedBox(
                                              width: 5,
                                            ),
                                ...
                                children: [
                                  ...
                                  InkWell(
                                      ...
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Text(widget.vendorModel.title, style: TextStyle(color: Color(colorPrimary))),
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text(
                                            ...
                                            style: TextStyle(fontWeight: FontWeight.bold, fontFamily: "Poppinsm", color: Color(colorPrimary)),
                                          ),
                                          GestureDetector(
                                            onTap: () {
                                              setState(() {
                            ...
                            child: Row(
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: Text(
                                    "See All".tr(),
                                    style: TextStyle(fontFamily: "Poppinsm", fontSize: 16, color: isDarkMode(context) ? const Color(0xffffffff) : Color(colorPrimary)),
                                  ),
                                ),
                              ],
                            ),
  ...
  Widget _buildChip(String label, int attributesOptionIndex, bool isSelected) {
    return Chip(
      ...
      backgroundColor: isSelected ? Color(colorPrimary) : Colors.white,
      elevation: 6.0,

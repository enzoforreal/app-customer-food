                ...
                child: SizedBox(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(10.0), borderSide: BorderSide(color: Color(colorPrimary), width: 2.0)),
                    ...
                    children: <Widget>[
                      ...
                      productModel.disPrice == "" || productModel.disPrice == "0"
                          ? Text(
                              ...
                              style: TextStyle(fontFamily: "Poppinsm", fontWeight: FontWeight.w600, letterSpacing: 0.5, color: Color(colorPrimary)),
                            )
                          : Row(
                              children: [
                                Text(

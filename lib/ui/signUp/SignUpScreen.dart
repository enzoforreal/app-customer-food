    ...
    return Column(
      children: <Widget>[
        Align(
            ...
            child: Text(
              'Create new account',
              style: TextStyle(color: Color(colorPrimary), fontWeight: FontWeight.bold, fontSize: 25.0),
            ).tr()),
        Padding(
          ...
          child: Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(25.0), borderSide: BorderSide(color: Color(colorPrimary), width: 2.0)),
          ...
          child: ConstrainedBox(
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                padding: EdgeInsets.only(top: 12, bottom: 12), backgroundColor: Color(colorPrimary),
        ...
        InkWell(
          ...
          child: Padding(
            ...
            child: Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(25), border: Border.all(color: Color(colorPrimary), width: 1)),
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                  ...
                  Text("Sign Up With Phone Number".tr(),
                    style: TextStyle(color: Color(colorPrimary), fontWeight: FontWeight.bold, letterSpacing: 1),
                  ),
                ])),
          ),
        )

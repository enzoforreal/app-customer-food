...
class WalletScreenState extends State<WalletScreen> {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Text(
            "TOPUP WALLET".tr(),
            style: TextStyle(color: Color(colorPrimary), fontWeight: FontWeight.w700, fontSize: 16),
          ),
        ),
      ),
    );
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ClipOval(
                  child: Container(
                    color: Color(colorPrimary).withOpacity(0.06),
                    child: Padding(
                      padding: const EdgeInsets.all(10.0),
                      child: Icon(Icons.account_balance_wallet_rounded, size: 28, color: Color(colorPrimary)),
                    ),
                  ),
                ),
                SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ClipOval(
                                  child: Container(
                                    color: Color(colorPrimary).withOpacity(0.05),
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Icon(Icons.account_balance_wallet_rounded, size: 28, color: Color(colorPrimary)),
                                    ),
                      ...
                      Visibility(
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: stripe ? Color(colorPrimary) : Colors.transparent)),
                      ...
                      Visibility(
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: payStack ? Color(colorPrimary) : Colors.transparent)),
                              controlAffinity: ListTileControlAffinity.trailing,
                              value: "PayStack",
                              groupValue: selectedRadioTile,
                              onChanged: (String? value) {
                      ...
                      Visibility(
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: flutterWave ? Color(colorPrimary) : Colors.transparent)),
                              controlAffinity: ListTileControlAffinity.trailing,
                              value: "FlutterWave",
                              groupValue: selectedRadioTile,
                              onChanged: (String? value) {
                      ...
                      Visibility(
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              //toggleable: true,
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: razorPay ? Color(colorPrimary) : Colors.transparent)),
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: 6,
                              ),
                              controlAffinity: ListTileControlAffinity.trailing,
                      ...
                      Visibility(
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: payFast ? Color(colorPrimary) : Colors.transparent)),
                              controlAffinity: ListTileControlAffinity.trailing,
                              value: "payFast",
                              groupValue: selectedRadioTile,
                              onChanged: (String? value) {
                      ...
                      Visibility(
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            elevation: payTm ? 0 : 2,
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: payTm ? Color(colorPrimary) : Colors.transparent)),
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: 6,
                              ),
                              controlAffinity: ListTileControlAffinity.trailing,
                      ...
                      Visibility(
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: mercadoPago ? Color(colorPrimary) : Colors.transparent)),
                              controlAffinity: ListTileControlAffinity.trailing,
                              value: "MercadoPago",
                              groupValue: selectedRadioTile,
                              onChanged: (String? value) {
                      ...
                      Visibility(
                        ...
                        child: Padding(
                          ...
                          child: Card(
                            ...
                            child: RadioListTile(
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(8), side: BorderSide(color: paypal ? Color(colorPrimary) : Colors.transparent)),
                              contentPadding: EdgeInsets.symmetric(
                                horizontal: 6,
                              ),
                              controlAffinity: ListTileControlAffinity.trailing,
  ...
  _flutterWaveInitiatePayment(
    ...
    final style = FlutterwaveStyle(
      ...
      appBarColor: Color(colorPrimary),
